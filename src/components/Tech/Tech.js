...
//             li className = 'tech__text-item' > Работа с префиксами, знание caniuse.com и особенностей браузеров < /li> { / * < li className = 'tech__text-item' > Умение создавать компоненты для переиспользования и избегать дублирования кода < /li> */
//         } <
//         /ul> < /
//     li > <
//         li className = 'tech__item' >
...
//     li className = 'tech__text-item' > Однопоточность, "main thread"
//     и "event loop queue" < /li> <
...
// li className = 'tech__text-item' > Работа с дебаггингом в js - консоли < /li> { / * < li className = 'tech__text-item' > Умение создавать компоненты для переиспользования и избегать дублирования кода < /li> */
// } <
// /ul> < /
// li > {
